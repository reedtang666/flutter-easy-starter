  ...
  void _onReject() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('温馨提示', style: TextStyle(color: AppColors.white)),
        content: const Text(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('返回查看', style: TextStyle(color: AppColors.lightGrey)),
          ),
          TextButton(
            onPressed: () {
              // 退出应用
            ...
            child: const Text('退出应用', style: TextStyle(color: AppColors.red)),
          ),
        ],
      ),
    );
